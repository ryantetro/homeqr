...
export default function ComparisonChart({
  ...
  const hasCurrentData = currentPeriod.scans > 0 || currentPeriod.leads > 0 || currentPeriod.pageViews > 0;
  const hasPreviousData = previousPeriod.scans > 0 || previousPeriod.leads > 0 || previousPeriod.pageViews > 0;
    ...
    return (
      <div className="h-80 flex items-center justify-center">
        <div className="text-center max-w-md px-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">No comparison data yet</h3>
          <p className="text-sm text-gray-600 mb-1">
            Start generating QR codes and tracking activity to see period-over-period comparisons.
          </p>
          <p className="text-xs text-gray-500">
            Compare this {periodLabel.toLowerCase()} to last {periodLabel.toLowerCase()} to track your growth.
          </p>
        </div>
      </div>
    );
